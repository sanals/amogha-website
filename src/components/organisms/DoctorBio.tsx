            ...
            <div>
              ...
              <ul className="space-y-3">
                {Array.isArray(doctor.experience) ? (
                  // If experience is an array, map through it
                  doctor.experience.map((exp, index) => (
                    <li key={index} className="flex items-start">
                      ...
                      <span className="text-neutral-dark dark:text-neutral-medium">{exp}</span>
                    </li>
                  ))
                ) : (
                  // If experience is a string, show as a single item
                  <li className="flex items-start">
                    ...
                    <span className="text-neutral-dark dark:text-neutral-medium">{doctor.experience}</span>
                  </li>
                )}
              </ul>
            </div>
